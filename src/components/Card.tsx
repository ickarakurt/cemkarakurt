    ...
    >
      ...
      <div className="flex items-center justify-between pt-3 mt-auto border-t border-skin-border/30">
        <div className="flex items-center gap-2">
          ...
          {collection && (
            <span
              className="inline-flex items-center gap-1 px-2 py-0.5 text-xxs font-medium rounded uppercase tracking-wider font-mono transition-all duration-200 bg-skin-accent/8 text-skin-accent border border-skin-accent/15"
            >
              <svg
